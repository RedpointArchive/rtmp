...
[![GoDoc](https://godoc.org/github.com/redpointgames/rtmp?status.svg)](https://godoc.org/github.com/redpointgames/rtmp)
...
```
go get github.com/redpointgames/rtmp
```
...
import (
        "github.com/redpointgames/rtmp/server"
)
...
of the RTMP specification. For example, the client knows how to:
  ...
  * Handshake itself by using the `github.com/redpointgames/rtmp/handshake` package
  * Receive RTMP control sequences using the `github.com/redpointgames/rtmp/control`
    package
  * More to come...

For more information on all of the things that the client can do, see the
[relevant
documentation](https://godoc.org/github.com/redpointgames/rtmp/client#Client).
