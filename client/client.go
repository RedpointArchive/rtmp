...
import (
	...
	"github.com/redpointgames/rtmp/cmd"
	"github.com/redpointgames/rtmp/control"
	"github.com/redpointgames/rtmp/handshake"
)

// Client represents a client connected to a RTMP server (see
// github.com/redpointgames/rtmp/server for more). Clients are able to be written to
...
// begin.
//
// See github.com/redpointgames/RTMP/handshake for details.
